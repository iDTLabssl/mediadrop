...
from mediacore.forms import FileField, Form, ListForm, SubmitButton, TextArea, TextField, XHTMLTextArea, MapButton, email_validator
...
class MediaForm(ListForm):
    ...
    fields = [
        ...
        MapButton('map', default=N_('Get Coordinates'), named_button=True, css_classes=['btn']),
